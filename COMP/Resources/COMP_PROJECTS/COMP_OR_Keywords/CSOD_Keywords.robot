...
Move_Files
    [Arguments]    ${File1PathSource}=/Users/Admin/Downloads/*.xls    ${File2PathDestination}=/Users/Admin/Automation/COMP/    ${OriginalFiles}=Comp_Adj_OG.xls
    ${MovedFile}=    Move File    ${File1PathSource}    ${File2PathDestination}
    Set Test Message    ${MovedFile}    append=True
    ${str}=    Replace String    ${MovedFile}    /Users/Admin/Automation/COMP/    ${EMPTY}
...
Download_Excel_And_Compare
    ...
    Excel_Save_As
    File_Exist    /Users/Admin/Downloads/*.xls
    Move_Files    /Users/Admin/Downloads/*.xls    /Users/Admin/Automation/COMP/    ${OriginalFile}
    Wait_For_File_Removed    /Users/Admin/Downloads/*.xls
